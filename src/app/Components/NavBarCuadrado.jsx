...
const NavCuadrados = () => {
  ...
  return (
    <>
      <div className='absolute min-h-screen w-full bg-transparent flex items-center justify-center p-0 z-0'>
        <div className='relative w-[60%] ml-1 h-96 grid grid-cols-2 grid-rows-2 '>
          <div className='relative navCard text-[#ffff00] hover:bg-[#e4e401] hover:border-t-3 bg-opacity-1 rounded-[10px 10px] hover:border-t-[#ffff00] hover:text-[#38382f] transition-all duration-500 ease-in-out hover:scale-105 cursor-pointer overflow-hidden group'>
            <p
              style={{ fontSize: "24px", marginLeft: "5px" }}
              className='absolute font-bold left-0 text-[25px] transition-colors pointer-events-none'
            >
              SERVICES
            </p>
            <div className='absolute bottom-4 left-0 right-0 px-4 space-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0'>
              {services.map((serv, key) => (
                <Link
                  ...
                  href={`/services/${serv.service
                    ?.toLowerCase()
                    .replace(/\s+/g, "-")}`}
                  className='block text-sm text-[#38382f]  hover:underline transition-all duration-200'
                >
                  {serv?.service}
                </Link>
              ))}
          ...
          <div className='h-[40%] relative navCard text-[#ffff00] hover:bg-[#e4e401] hover:border-t-3 bg-opacity-1 hover:border-t-[#ffff00]  hover:text-[#38382f] transition-all duration-500 ease-in-out hover:scale-105 cursor-pointer overflow-hidden'>
            <a
              style={{ fontSize: "24px" }}
              href='contact-us'
              className='text-[25px] big-center absolute top-2 right-2 text-sm font-bold transition-colors pointer-events-none'
            >
              CONTACT US
            </a>
          </div>

          <div className='relative navCardBottom row-start-2 self-end h-[40%] text-[#ffff00] hover:bg-[#e4e401] hover:border-b-3 bg-opacity-1 hover:border-b-[#ffff00]  hover:text-[#38382f] transition-all duration-500 ease-in-out hover:scale-105 cursor-pointer overflow-hidden'>
            <a
              href='about-us'
              style={{ fontSize: "24px", marginLeft: "5px" }}
              className='absolute z-10 font-bold left-0 bottom-2 text-[25px] transition-colors pointer-events-none'
            >
              ABOUT US
            </a>
          </div>

          <div className='relative row-start-2 self-end h-[40%] navCardBottom text-[#ffff00] hover:bg-[#e4e401] hover:border-b-3 bg-opacity-1  hover:text-[#38382f] hover:border-b-[#ffff15]  transition-all duration-500 ease-in-out hover:scale-105 cursor-pointer overflow-hidden'>
            <a
              style={{ fontSize: "24px" }}
              href='#acerca'
              className='absolute font-bold bottom-2 right-2 text-sm transition-colors pointer-events-none'
            >
              GALLERY
            </a>
          </div>
