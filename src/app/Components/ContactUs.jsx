    ...
    <>
      <div className='w-full '>
        ...
        <div className='grid grid-cols-2 gap-3'>
          ...
          <div className='col-span-2 flex justify-center items-center gap-2 p-2'>
            <Image
          ...
          <div className='flex items-center  justify-center  j gap-2 p-2'>
            <Image
              src='/images-footer/EMAILICON.svg'
              alt='email'
              width={20}
        ...
        <div className='flex justify-center mt-[40px]'>
          <div className='w-[80%] max-w-4xl h-[1px] border-t-2 border-[#FFFF00] mb-[35px]'></div>
        </div>
        <h2 className='text-[24px] font-bold text-[#FFFF00]  mb-[20px]'>
          GET IN TOUCH
        </h2>
        <div className='w-full max-w-4xl mx-auto p-6 md:p-6'>
