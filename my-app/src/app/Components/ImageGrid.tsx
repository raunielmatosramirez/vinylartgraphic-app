...
const ImageGrid = ({images}: ImageGridProps) => {
    ...
    return (
        <section className="flex flex-col items-center justify-center text-center">
            <HeaderSection title="ALUMINUM SIGN" text="Lorem ipsum dolor sit amet, consectetur adipisicing elit.
             Cupiditate laborum modi nesciunt? Animi eveniet incidunt laborum magni
             numquam omnis sed sunt suscipit velit? Ad consequatur doloremque ea in optio, quis?"/>
